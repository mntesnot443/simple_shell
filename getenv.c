...
/**
 * _setenv -  Modify the existing one, or
 *	Initialize the new env't variable.
 * @info: structure to be containing potential argument.
 * @var: A property of string env var.
 * @value: The value of string env var
 *  Return: 0
 */
...
/**
 * get_environ - To return a string array copy of our environ
 * @info: structure to be containing potential argument.
 * Return: 0
 */
